...
### 7b26
Merge conflict:
- MidnightSP: Created a resourcepack for numismatics and railways navigator
- Guzio: Moved our datapack
...
2. If using Grinch, navigate to the repo's main folder (one level above this `README.md`) inside your terminal. If not using Grinch, do so in your file explorer.
2. Run `grinch export --quick` or `grinch e -q` for short (or manually zip the __content__ (ie. don't include the folder itself) of `ghostland7` into `GhostLand 7.mrpack`, if you don't have Grinch installed).
3. Import `GhostLand 7.mrpack` using Modrinth;
4. Now you can play!

### How to contribute:
1. Clone this repo;
2. Navigate to its main folder (one level above this `README.md`) inside your terminal;
